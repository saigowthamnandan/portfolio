...
const Sparkles = ({color = null, scale = 1, children, ...delegated}: SparklesProps) => {
  ...
  return (
    <span className="sp-wrapper" {...delegated}>
      {sparkles.map((sparkle) => (
        <Sparkle key={sparkle.id} color={sparkle.color} size={sparkle.size * scale} style={sparkle.style} />
      ))}
